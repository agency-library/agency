...
{
namespace new_multi_agent_then_execute_with_shared_inits_returning_user_specified_container_implementation_strategies
{
...
using has_strategy_1 = new_has_multi_agent_then_execute_with_shared_inits_returning_user_specified_container<
  Executor,
  Function,
  Factory,
  Future,
...
{
  using type = new_has_multi_agent_then_execute_with_shared_inits_returning_user_specified_container<
    Executor,
    Function,
    Factory,
    Future,
...
{
  return ex.new_then_execute(f, result_factory, shape, fut, shared_factories...);
...
>
  multi_agent_then_execute_with_shared_inits_returning_user_specified_container(use_multi_agent_when_all_execute_and_select_with_shared_inits_member_function,
                                                                                Executor& ex, Function f, Factory result_factory, typename new_executor_traits<Executor>::shape_type shape, Future& fut, Factories... shared_factories)
{
...
struct strategy_3_functor
{
  ...
  {
    return new_executor_traits<Executor>::execute(ex, inner_functor{f,val}, result_factory, shape, std::get<Indices>(shared_inits)...);
  }
...
struct strategy_3_functor<Executor,Function,Factory,void,Tuple>
{
  ...
  {
    return new_executor_traits<Executor>::execute(ex, inner_functor{f}, result_factory, shape, detail::get<Indices>(shared_factories)...);
  }
...
strategy_3_functor<
  ...
  >
>
make_strategy_3_functor(Executor& ex, Function f, Factory result_factory, typename new_executor_traits<Executor>::shape_type shape, Future& fut, Factories... shared_factories)
{
...
} // end new_multi_agent_then_execute_with_shared_inits_returning_user_specified_container_implementation_strategies
...
>
  new_executor_traits<Executor>
    ::new_then_execute(typename new_executor_traits<Executor>::executor_type& ex,
                       Function f,
                       ...
                       Factories... shared_factories)
{
  namespace ns = detail::new_executor_traits_detail::new_multi_agent_then_execute_with_shared_inits_returning_user_specified_container_implementation_strategies;
