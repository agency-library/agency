...
using has_strategy_1 = new_has_multi_agent_execute_with_shared_inits_returning_user_specified_container<Executor,Function,Factory,Factories...>;

template<class Executor, class Function, class Factory, class... Factories>
struct has_strategy_1_workaround_nvbug_1665745
{
  using type = new_has_multi_agent_execute_with_shared_inits_returning_user_specified_container<Executor,Function,Factory,Factories...>;
};
...
template<class Executor, class Function, class Factory, class... Factories>
using has_strategy_2 = new_has_multi_agent_execute_returning_user_specified_container<Executor,test_function_returning_int,Factory>;
...
{
  return ex.new_execute(f, result_factory, shape, shared_factories...);
                                                                           ...
                                                                           Factories... shared_factories)
{
  ...
  return ex.new_execute(g, result_factory, shape);
} // end multi_agent_execute_with_shared_inits_returning_user_specified_container()
