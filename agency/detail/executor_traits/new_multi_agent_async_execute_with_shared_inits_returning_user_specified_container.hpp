...
{
namespace new_multi_agent_async_execute_with_shared_inits_returning_user_specified_container_implementation_strategies
{
...
{
  return ex.new_async_execute(f, result_factory, shape, shared_factories...);
...
} // end new_multi_agent_async_execute_with_shared_inits_returning_user_specified_container_implementation_strategies
...
>
  new_executor_traits<Executor>
    ::new_async_execute(typename new_executor_traits<Executor>::executor_type& ex,
                        Function f,
                        Factory result_factory,
                        typename new_executor_traits<Executor>::shape_type shape,
                        Factories... shared_factories)
{
  using check_for_member_function = detail::new_executor_traits_detail::new_has_multi_agent_async_execute_with_shared_inits_returning_user_specified_container<
    Executor,
    Function,
    Factory,
    Factories...
  ...
  namespace ns = detail::new_executor_traits_detail::new_multi_agent_async_execute_with_shared_inits_returning_user_specified_container_implementation_strategies;
