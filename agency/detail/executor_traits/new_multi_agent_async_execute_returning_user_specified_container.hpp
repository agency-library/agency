...
{
namespace new_multi_agent_async_execute_returning_user_specified_container_implementation_strategies
{
...
{
  return ex.new_async_execute(f, result_factory, shape);
...
} // end new_multi_agent_async_execute_returning_user_specified_container_implementation_strategies
...
{
  using check_for_member_function = detail::new_executor_traits_detail::new_has_multi_agent_async_execute_returning_user_specified_container<
    Executor,
    Function,
    Factory
  >;

  namespace ns = detail::new_executor_traits_detail::new_multi_agent_async_execute_returning_user_specified_container_implementation_strategies;
