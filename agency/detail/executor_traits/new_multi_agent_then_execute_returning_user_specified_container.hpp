...
{
namespace new_multi_agent_then_execute_returning_user_specified_container_implementation_strategies
{
...
using select_multi_agent_then_execute_returning_user_specified_container_implementation =
  typename std::conditional<
    new_has_multi_agent_then_execute_returning_user_specified_container<Executor,Function,Factory,Future>::value,
...
{
  return ex.new_then_execute(f, result_factory, shape, fut);
                                                                   ...
                                                                   const Tuple& tuple_of_unit_factories)
{
  ...
  return new_executor_traits<Executor>::new_then_execute(ex, ignore_tail_parameters_and_invoke<Function,value_type>{f}, result_factory, shape, fut, std::get<Indices>(tuple_of_unit_factories)...);
...
} // end new_multi_agent_then_execute_returning_user_specified_container_implementation_strategies
...
>
  new_executor_traits<Executor>
    ::new_then_execute(typename new_executor_traits<Executor>::executor_type& ex,
                       ...
                       Future& fut)
{
  namespace ns = detail::new_executor_traits_detail::new_multi_agent_then_execute_returning_user_specified_container_implementation_strategies;
