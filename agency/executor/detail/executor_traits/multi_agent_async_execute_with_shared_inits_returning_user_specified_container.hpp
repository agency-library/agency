  ...
  multi_agent_async_execute_with_shared_inits_returning_user_specified_container(std::false_type, Executor& ex, Function f, Factory result_factory, typename executor_traits<Executor>::shape_type shape, Factories... shared_factories)
{
  ...
  return executor_traits<Executor>::then_execute(ex, f, result_factory, shape, ready, shared_factories...);
} // end multi_agent_async_execute_with_shared_inits_returning_user_specified_container()
...
{
  using check_for_member_function = detail::executor_traits_detail::has_multi_agent_async_execute_with_shared_inits_returning_user_specified_container<
    Executor,
    Function,
    Factory,
    Factories...
  ...
  namespace ns = detail::executor_traits_detail::multi_agent_async_execute_with_shared_inits_returning_user_specified_container_implementation_strategies;
