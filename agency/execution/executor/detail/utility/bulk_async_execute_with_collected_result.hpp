...
executor_future_t<E,result_of_t<ResultFactory()>>
  bulk_async_execute_with_collected_result(const E& exec, Function f, executor_shape_t<E> shape, ResultFactory result_factory, SharedFactories... shared_factories)
{
