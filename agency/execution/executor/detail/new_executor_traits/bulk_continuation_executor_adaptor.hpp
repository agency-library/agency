...
class bulk_continuation_executor_adaptor<BulkExecutor,true>
{
  ...
  public:
    using execution_category = executor_execution_category_t<BulkExecutor>;
    ...
    {
      return agency::detail::new_executor_traits_detail::bulk_then_execute(adapted_executor_, f, shape, predecessor, result_factory, shared_factories...);
    }
};
