...
using concurrent_agent = detail::basic_concurrent_agent<std::size_t, detail::default_concurrent_resource>;
using concurrent_agent_1d = concurrent_agent;
using concurrent_agent_2d = detail::basic_concurrent_agent<size2, detail::default_concurrent_resource>;
