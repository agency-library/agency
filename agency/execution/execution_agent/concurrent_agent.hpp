...
using default_barrier = concurrent_agent_barrier;
...
using concurrent_agent = detail::basic_concurrent_agent<std::size_t, detail::concurrent_agent_barrier, detail::default_concurrent_resource>;
using concurrent_agent_1d = concurrent_agent;
using concurrent_agent_2d = detail::basic_concurrent_agent<size2, detail::concurrent_agent_barrier, detail::default_concurrent_resource>;
