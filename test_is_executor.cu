...
int main()
{
  ...
  std::cout << "has_then_execute<grid_executor>: " << agency::detail::has_multi_agent_then_execute<agency::cuda::grid_executor>::value << std::endl;

  std::cout << "is_executor<block_executor>: " << agency::is_executor<agency::cuda::block_executor>::value << std::endl;
  std::cout << "has_then_execute<block_executor>: " << agency::detail::has_multi_agent_then_execute<agency::cuda::block_executor>::value << std::endl;

  std::cout << "is_executor<cuda::parallel_executor>: " << agency::is_executor<agency::cuda::parallel_executor>::value << std::endl;
  std::cout << "has_then_execute<cuda::parallel_executor>: " << agency::detail::has_multi_agent_then_execute<agency::cuda::parallel_executor>::value << std::endl;

  std::cout << "is_executor<cuda::concurrent_executor>: " << agency::is_executor<agency::cuda::concurrent_executor>::value << std::endl;
  std::cout << "has_then_execute<cuda::concurrent_executor>: " << agency::detail::has_multi_agent_then_execute<agency::cuda::concurrent_executor>::value << std::endl;
