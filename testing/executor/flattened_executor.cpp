...
void test(OuterExecutor outer_exec, InnerExecutor inner_exec)
{
  ...
  static_assert(agency::detail::is_detected_exact<size_t, executor_shape_t, flattened_executor_type>::value,
    "flattened_executor should have size_t shape_type");

  static_assert(agency::detail::is_detected_exact<size_t, executor_index_t, flattened_executor_type>::value,
