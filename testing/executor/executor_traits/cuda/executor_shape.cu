...
int main()
{
  ...
  static_assert(agency::detail::is_detected_exact<agency::uint2, agency::new_executor_shape_t, agency::cuda::grid_executor>::value, "grid_executor should have uint2 shape_type");
