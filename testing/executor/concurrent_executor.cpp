...
int main()
{
  ...
  static_assert(agency::detail::is_detected_exact<size_t, agency::new_executor_index_t, agency::concurrent_executor>::value,
    "concurrent_executor should have size_t index_type");

  static_assert(agency::detail::is_detected_exact<std::future<int>, agency::new_executor_future_t, agency::concurrent_executor, int>::value,
