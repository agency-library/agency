...
void test(OuterExecutor outer_exec, InnerExecutor inner_exec)
{
  ...
  static_assert(agency::detail::is_detected_exact<agency::detail::tuple<size_t,size_t>, executor_shape_t, executor_array_type>::value,
    "executor_array should have detail::tuple<size_t,size_t> shape_type");

  static_assert(agency::detail::is_detected_exact<agency::detail::index_tuple<size_t,size_t>, executor_index_t, executor_array_type>::value,
