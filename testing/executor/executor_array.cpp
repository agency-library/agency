...
void test(OuterExecutor outer_exec, InnerExecutor inner_exec)
{
  ...
  static_assert(agency::is_bulk_continuation_executor<executor_array_type>::value,
  ...
  static_assert(agency::detail::is_detected_exact<agency::new_executor_future_t<OuterExecutor,int>, agency::new_executor_future_t, executor_array_type, int>::value,
