...
void test(OuterExecutor outer_exec, InnerExecutor inner_exec)
{
  ...
  static_assert(agency::detail::is_detected_exact<agency::detail::tuple<size_t,size_t>, executor_shape_t, scoped_executor_type>::value,
    "scoped_executor should have detail::tuple<size_t,size_t> shape_type");

  static_assert(agency::detail::is_detected_exact<agency::detail::index_tuple<size_t,size_t>, executor_index_t, scoped_executor_type>::value,
    "scoped_executor should have detail::index_tuple<size_t,size_t> index_type");

  static_assert(agency::detail::is_detected_exact<executor_future_t<OuterExecutor,int>, executor_future_t, scoped_executor_type, int>::value,
