...
void launch_nested_kernel()
{
  ...
  agency::detail::bulk_execute_with_auto_result_and_without_shared_parameters(ex, hello_world(), agency::uint2{2,2});
}
...
int main()
{
  ...
  agency::detail::bulk_execute_with_auto_result(ex, with_shared_arg(), agency::uint2{2,2}, [] __host__ __device__ { return 7; }, [] __host__ __device__ { return 13; });
  std::cout << std::endl;
